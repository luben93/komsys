...
public class AudioStreamUDP {
	...
	public static final int BUFFER_VS_FRAMES_RATIO = 16;

	public AudioStreamUDP() throws IOException {
		this.receiverSocket = new DatagramSocket(5000);
	...
	public synchronized void connectTo(String ip, int port) 
		throws IOException {
		sender.connectTo(InetAddress.getByName(ip),5000);
		receiver.connectTo(InetAddress.getByName(ip));
	}
